...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, "Control" }, "p", function() awful.spawn.with_shell("sleep 0.3 && screenshot -s") end,
              {description = "select a screenshot area", group = "hotkeys"}),
    ...
    awful.key({ altkey }, "Up",
        function ()
            os.execute(string.format("amixer -q -D pulse sset Master 1%%+"))
    ...
    awful.key({ altkey }, "m",
        function ()
            os.execute(string.format("amixer -q -D pulse sset Master toggle"))
            beautiful.volume.update()
        end,
        {description = "toggle mute", group = "hotkeys"}),
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer -q -D pulse sset Master 100%%"))
            beautiful.volume.update()
        end,
        {description = "volume 100%", group = "hotkeys"}),
    awful.key({ altkey, "Control" }, "0",
        function ()
            os.execute(string.format("amixer -q -D pulse sset Master 0%%"))
            beautiful.volume.update()
        end,
    ...
    awful.key({ modkey, "Shift" }, "v", function () awful.spawn.with_shell("vpn.sh") end,
              {description = "connect to CRG VPN", group = "launcher"}),
