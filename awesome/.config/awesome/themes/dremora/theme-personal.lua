...
theme.wallpaper                                 = os.getenv("HOME") .. "/Pictures/wallpapers/vladstudio_full_moon_wallpaper.jpg"
theme.font                                      = "Terminus 10.5"
theme.taglist_font                              = "la-solid-400 10"
...
theme.weather = lain.widget.weather({
    city_id = 3128760, -- placeholder (London)
    settings = function()
